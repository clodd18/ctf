            ...
            <div class="ml-12 mr-12">
                <form action="{{route('retos.store')}}" method="POST">
                    ...
                    <div class="mt-1">
                        ...
                        <input class=" border-gray-300 text-gray-500 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" type="text" name="nombre" style="width: 500px;" value="{{old('nombre')}}">
                        @error('nombre')
                            <br>
                            <small>*{{$message}}</small>
                            <br>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea class="border-gray-300 text-gray-500 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="descripcion" rows="5" style="width: 500px;">{{old('descripcion')}}</textarea>
                        @error('descripcion')
                            <br>
                            <small>*{{$message}}</small>
                            <br>
                    ...
                    <div class="mt-4">
                        ...
                        <select class=" border-gray-300 text-gray-500 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" type="text" name="categoria" style="width: 500px;" value="{{old('enlace')}}">
                    ...
                    <div class="mt-4">
                        ...
                        <input class=" border-gray-300 text-gray-500 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" type="text" name="enlace" style="width: 500px;" value="{{old('enlace')}}">
                        @error('enlace')
                            <br>
                            <small>*{{$message}}</small>
                            <br>
